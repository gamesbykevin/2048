...
package com.gamesbykevin.a2048.opengl.text;
...
public class GLText {
   ...
   public void draw(String text, float x, float y)  {
     ...
     * @return pixel height of a single character
     */
   ...
   public void drawTexture(int width, int height)  {
      ...
      batch.drawSprite((int)(width * 1.25), (int)(height * 1.25), textureSize, textureSize, textureRgn );  // Draw
